...
from utils import resize_and_crop_y, normalize, split_img_into_squares, hwc_to_chw, merge_masks, dense_crf
...
def get_args():
    ...
    parser.add_argument('--input', '-i', default='/home/lixiaoxing/data/DRIVE/test/',
                        help='filenames of input images', required=True)
    parser.add_argument('--output', '-o', default='/home/lixiaoxing/github/Pytorch-UNet/results/',
                        help='filenames of ouput images')
...
if __name__ == "__main__":
    ...
    print(in_files)
    for fn in os.listdir(in_files):
        print("\nPredicting image {} ...".format(fn))
        [path, filen]=os.path.split(in_files)
